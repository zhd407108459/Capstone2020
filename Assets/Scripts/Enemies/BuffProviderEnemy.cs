    ...
    void BuffOthers()
    {
        if(buffType == 0)
        {
            ...
            if (SettingManager.instance != null)
            {
                ...
                enemyExtraHealthBuffFX.setVolume(SettingManager.instance.overAllVolume * value);
            }
        ...
        else if (buffType == 1)
        {
            ...
            {
                float value = Mathf.Clamp(Vector2.Distance(GameManager.instance.player.transform.position, transform.position), 0, SettingManager.instance.hearingRange) / SettingManager.instance.hearingRange;
                enemyHealBuffFX.setVolume(SettingManager.instance.overAllVolume * value);
            }
        ...
        else if (buffType == 2)
        {
            ...
            {
                float value = Mathf.Clamp(Vector2.Distance(GameManager.instance.player.transform.position, transform.position), 0, SettingManager.instance.hearingRange) / SettingManager.instance.hearingRange;
                enemyPowerupBuffFX.setVolume(SettingManager.instance.overAllVolume * value);
            }
