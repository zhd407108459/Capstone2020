...
public class QuickChargeBuff : BasicBuff
{
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        if (collision.tag.Equals("Player"))
        {
            ...
            GameManager.instance.player.GetComponent<PlayerAction>().StartQuickCharge(effectTime);
